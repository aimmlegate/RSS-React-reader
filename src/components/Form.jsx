...
export default class Form extends React.Component {
  ...
  renderFormMessage() {
    ...
    return <div className={validClass}>{this.props.formStatus.message}</div>;
  }
  render() {
    const { status } = this.props.formStatus;
      ...
      <div className="jumbotron jumbotron-fluid">
        <div className="container">
          ...
          <p className="lead">
            ...
            online content in a standardized, computer-readable format. The news
            aggregator will automatically check the RSS feed for new content.{" "}
          </p>
          <div className="row">
